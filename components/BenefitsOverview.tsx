...
const benefits = [
  ...
  { icon: "🧾", title: "Long-term care planning — a complete asset picture", desc: "When a family comes to an elder law attorney for long-term care planning, MyLifeFolio delivers a complete, organized financial and legal snapshot — cutting intake time dramatically.", tags: ["Financial Life", "Legal Documents", "Documents Vault"], cat: "Professional" },
