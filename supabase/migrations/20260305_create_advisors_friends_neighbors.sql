...
CREATE INDEX idx_folio_advisors_intake_id ON folio_advisors(intake_id);
CREATE INDEX idx_folio_advisors_user_id ON folio_advisors(user_id);
...
CREATE INDEX idx_folio_friends_neighbors_intake_id ON folio_friends_neighbors(intake_id);
CREATE INDEX idx_folio_friends_neighbors_user_id ON folio_friends_neighbors(user_id);
