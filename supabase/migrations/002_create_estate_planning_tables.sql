...
-- Add comments
COMMENT ON TABLE folio_intakes IS 'Main intake record for estate planning clients';
COMMENT ON TABLE folio_children IS 'Children of the client/spouse';
COMMENT ON TABLE folio_beneficiaries IS 'Other beneficiaries (grandchildren, friends, etc.)';
COMMENT ON TABLE folio_charities IS 'Charitable beneficiaries';
COMMENT ON TABLE folio_real_estate IS 'Real estate holdings';
COMMENT ON TABLE folio_bank_accounts IS 'Bank accounts (checking, savings, CDs, money market)';
COMMENT ON TABLE folio_investments IS 'Non-qualified investment accounts';
COMMENT ON TABLE folio_retirement_accounts IS 'Retirement accounts (401k, IRA, pension, etc.)';
COMMENT ON TABLE folio_life_insurance IS 'Life insurance policies';
COMMENT ON TABLE folio_vehicles IS 'Vehicles (cars, boats, RVs, etc.)';
COMMENT ON TABLE folio_other_assets IS 'Other assets including personal property';
COMMENT ON TABLE folio_business_interests IS 'Business ownership interests';
COMMENT ON TABLE folio_digital_assets IS 'Digital assets (crypto, domains, etc.)';
COMMENT ON TABLE folio_specific_gifts IS 'Specific gifts of items to named beneficiaries';
COMMENT ON TABLE folio_cash_gifts IS 'Cash bequests to beneficiaries';
