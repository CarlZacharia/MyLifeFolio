...
CREATE TABLE IF NOT EXISTS folio_current_estate_plan (
  ...
  will_storage_location TEXT,
  will_storage_location_other TEXT,
  will_storage_notes TEXT,
  will_attorney_name TEXT,
  will_attorney_firm TEXT,
  will_attorney_email TEXT,
  will_attorney_phone TEXT,
  will_attorney_address TEXT,
  trust_date_signed TEXT,
  trust_state_signed TEXT,
  trust_name TEXT,
  trust_state_resided TEXT,
  trust_storage_location TEXT,
  trust_storage_location_other TEXT,
  trust_storage_notes TEXT,
  trust_attorney_name TEXT,
  trust_attorney_firm TEXT,
  trust_attorney_email TEXT,
  trust_attorney_phone TEXT,
  trust_attorney_address TEXT,
  ...
  irrevocable_trust_storage_location TEXT,
  irrevocable_trust_storage_location_other TEXT,
  irrevocable_trust_storage_notes TEXT,
  irrevocable_trust_attorney_name TEXT,
  irrevocable_trust_attorney_firm TEXT,
  irrevocable_trust_attorney_email TEXT,
  irrevocable_trust_attorney_phone TEXT,
  irrevocable_trust_attorney_address TEXT,
  financial_poa_date_signed TEXT,
  financial_poa_state_signed TEXT,
  financial_poa_storage_location TEXT,
  financial_poa_storage_location_other TEXT,
  financial_poa_storage_notes TEXT,
  financial_poa_attorney_name TEXT,
  financial_poa_attorney_firm TEXT,
  financial_poa_attorney_email TEXT,
  financial_poa_attorney_phone TEXT,
  financial_poa_attorney_address TEXT,
  health_care_poa_date_signed TEXT,
  health_care_poa_state_signed TEXT,
  health_care_poa_storage_location TEXT,
  health_care_poa_storage_location_other TEXT,
  health_care_poa_storage_notes TEXT,
  health_care_poa_attorney_name TEXT,
  health_care_poa_attorney_firm TEXT,
  health_care_poa_attorney_email TEXT,
  health_care_poa_attorney_phone TEXT,
  health_care_poa_attorney_address TEXT,
  living_will_storage_location TEXT,
  living_will_storage_location_other TEXT,
  living_will_storage_notes TEXT,
  living_will_attorney_name TEXT,
  living_will_attorney_firm TEXT,
  living_will_attorney_email TEXT,
  living_will_attorney_phone TEXT,
  living_will_attorney_address TEXT,
