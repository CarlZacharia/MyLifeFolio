...
export function buildReportData(fd: Record<string, any>): ReportDataBundle {
  ...
  const mapEstatePlan = (plan: any, personType: string) => {
    ...
    return {
      ...
      will_storage_location: p.willStorageLocation || undefined,
      will_storage_location_other: p.willStorageLocationOther || undefined,
      will_storage_notes: p.willStorageNotes || undefined,
      will_attorney_name: p.willAttorneyName || undefined,
      will_attorney_firm: p.willAttorneyFirm || undefined,
      will_attorney_email: p.willAttorneyEmail || undefined,
      will_attorney_phone: p.willAttorneyPhone || undefined,
      will_attorney_address: p.willAttorneyAddress || undefined,
      trust_storage_location: p.trustStorageLocation || undefined,
      trust_storage_location_other: p.trustStorageLocationOther || undefined,
      trust_storage_notes: p.trustStorageNotes || undefined,
      trust_attorney_name: p.trustAttorneyName || undefined,
      trust_attorney_firm: p.trustAttorneyFirm || undefined,
      trust_attorney_email: p.trustAttorneyEmail || undefined,
      trust_attorney_phone: p.trustAttorneyPhone || undefined,
      trust_attorney_address: p.trustAttorneyAddress || undefined,
      irrevocable_trust_storage_location: p.irrevocableTrustStorageLocation || undefined,
      irrevocable_trust_storage_location_other: p.irrevocableTrustStorageLocationOther || undefined,
      irrevocable_trust_storage_notes: p.irrevocableTrustStorageNotes || undefined,
      irrevocable_trust_attorney_name: p.irrevocableTrustAttorneyName || undefined,
      irrevocable_trust_attorney_firm: p.irrevocableTrustAttorneyFirm || undefined,
      irrevocable_trust_attorney_email: p.irrevocableTrustAttorneyEmail || undefined,
      irrevocable_trust_attorney_phone: p.irrevocableTrustAttorneyPhone || undefined,
      irrevocable_trust_attorney_address: p.irrevocableTrustAttorneyAddress || undefined,
      financial_poa_storage_location: p.financialPOAStorageLocation || undefined,
      financial_poa_storage_location_other: p.financialPOAStorageLocationOther || undefined,
      financial_poa_storage_notes: p.financialPOAStorageNotes || undefined,
      financial_poa_attorney_name: p.financialPOAAttorneyName || undefined,
      financial_poa_attorney_firm: p.financialPOAAttorneyFirm || undefined,
      financial_poa_attorney_email: p.financialPOAAttorneyEmail || undefined,
      financial_poa_attorney_phone: p.financialPOAAttorneyPhone || undefined,
      financial_poa_attorney_address: p.financialPOAAttorneyAddress || undefined,
      health_care_poa_storage_location: p.healthCarePOAStorageLocation || undefined,
      health_care_poa_storage_location_other: p.healthCarePOAStorageLocationOther || undefined,
      health_care_poa_storage_notes: p.healthCarePOAStorageNotes || undefined,
      health_care_poa_attorney_name: p.healthCarePOAAttorneyName || undefined,
      health_care_poa_attorney_firm: p.healthCarePOAAttorneyFirm || undefined,
      health_care_poa_attorney_email: p.healthCarePOAAttorneyEmail || undefined,
      health_care_poa_attorney_phone: p.healthCarePOAAttorneyPhone || undefined,
      health_care_poa_attorney_address: p.healthCarePOAAttorneyAddress || undefined,
      living_will_storage_location: p.livingWillStorageLocation || undefined,
      living_will_storage_location_other: p.livingWillStorageLocationOther || undefined,
      living_will_storage_notes: p.livingWillStorageNotes || undefined,
      living_will_attorney_name: p.livingWillAttorneyName || undefined,
      living_will_attorney_firm: p.livingWillAttorneyFirm || undefined,
      living_will_attorney_email: p.livingWillAttorneyEmail || undefined,
      living_will_attorney_phone: p.livingWillAttorneyPhone || undefined,
      living_will_attorney_address: p.livingWillAttorneyAddress || undefined,
